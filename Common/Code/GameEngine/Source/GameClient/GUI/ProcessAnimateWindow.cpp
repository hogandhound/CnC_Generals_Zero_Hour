...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initReverseAnimateWindow( AnimateWindowWW *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initAnimateWindow( AnimateWindowWW *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRight::updateAnimateWindow( AnimateWindowWW *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRight::reverseAnimateWindow( AnimateWindowWW *animWin )
{
...
void ProcessAnimateWindowSlideFromLeft::initReverseAnimateWindow( AnimateWindowWW *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromLeft::initAnimateWindow( AnimateWindowWW *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromLeft::updateAnimateWindow( AnimateWindowWW *animWin )
{
...
Bool ProcessAnimateWindowSlideFromLeft::reverseAnimateWindow( AnimateWindowWW *animWin )
{
...
void ProcessAnimateWindowSlideFromTop::initReverseAnimateWindow( AnimateWindowWW *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTop::initAnimateWindow( AnimateWindowWW *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTop::updateAnimateWindow( AnimateWindowWW *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTop::reverseAnimateWindow( AnimateWindowWW *animWin )
{
...
void ProcessAnimateWindowSlideFromBottom::initReverseAnimateWindow( AnimateWindowWW *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromBottom::initAnimateWindow( AnimateWindowWW *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottom::updateAnimateWindow( AnimateWindowWW *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottom::reverseAnimateWindow( AnimateWindowWW *animWin )
{
...
void ProcessAnimateWindowSlideFromBottomTimed::initReverseAnimateWindow( AnimateWindowWW *animWin, UnsignedInt maxDelay )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
void ProcessAnimateWindowSlideFromBottomTimed::initAnimateWindow( AnimateWindowWW *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottomTimed::updateAnimateWindow( AnimateWindowWW *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottomTimed::reverseAnimateWindow( AnimateWindowWW *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initReverseAnimateWindow( AnimateWindowWW *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initAnimateWindow( AnimateWindowWW *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::updateAnimateWindow( AnimateWindowWW *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::reverseAnimateWindow( AnimateWindowWW *animWin )
{
...
void ProcessAnimateWindowSlideFromTopFast::initReverseAnimateWindow( AnimateWindowWW *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTopFast::initAnimateWindow( AnimateWindowWW *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTopFast::updateAnimateWindow( AnimateWindowWW *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTopFast::reverseAnimateWindow( AnimateWindowWW *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initReverseAnimateWindow( AnimateWindowWW *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initAnimateWindow( AnimateWindowWW *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D size = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRightFast::updateAnimateWindow( AnimateWindowWW *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRightFast::reverseAnimateWindow( AnimateWindowWW *animWin )
{
