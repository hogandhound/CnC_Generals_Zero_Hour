...
{
	VKFVF_XYZ,
	VKFVF_XYZ|VKFVF_DIFFUSE,
	VKFVF_XYZ|VKFVF_TEX1,
	VKFVF_XYZ|VKFVF_DIFFUSE|VKFVF_TEX1,
	VKFVF_XYZ|VKFVF_TEX2,
	VKFVF_XYZ|VKFVF_DIFFUSE|VKFVF_TEX2,
	VKFVF_XYZ|VKFVF_NORMAL,
	VKFVF_XYZ|VKFVF_NORMAL|VKFVF_DIFFUSE,
	VKFVF_XYZ|VKFVF_NORMAL|VKFVF_TEX1,
	VKFVF_XYZ|VKFVF_NORMAL|VKFVF_DIFFUSE|VKFVF_TEX1,
	VKFVF_XYZ|VKFVF_NORMAL|VKFVF_TEX2,
	VKFVF_XYZ|VKFVF_NORMAL|VKFVF_DIFFUSE|VKFVF_TEX2,
	VKFVF_XYZRHW,
	VKFVF_XYZRHW|VKFVF_DIFFUSE,
	VKFVF_XYZRHW|VKFVF_TEX1,
	VKFVF_XYZRHW|VKFVF_DIFFUSE|VKFVF_TEX1,
	VKFVF_XYZRHW|VKFVF_TEX2,
	VKFVF_XYZRHW|VKFVF_DIFFUSE|VKFVF_TEX2
};
...
Bool W3DBufferManager::ReAcquireResources(void)
{
	...
	{	DEBUG_ASSERTCRASH( ib->m_DX8IndexBuffer == NULL, ("ReAcquire of existing index buffer"));
		ib->m_DX8IndexBuffer=NEW_REF(DX8IndexBufferClass,(ib->m_size));
...
//	Int sizeIndex = (size >> MIN_SLOT_SIZE_SHIFT)-1;
	...
	if (m_numEmptyIndexBuffersAllocated < MAX_INDEX_BUFFERS_CREATED)
	{
		...
		pIB->m_DX8IndexBuffer=NEW_REF(DX8IndexBufferClass,(ibSize));
		pIB->m_startFreeIndex=size;
		pIB->m_size=ibSize;
		ibSlot=&m_W3DIndexBufferEmptySlots[m_numEmptyIndexSlotsAllocated];
		m_numEmptyIndexSlotsAllocated++;
