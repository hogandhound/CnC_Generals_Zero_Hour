...
void WWVK_CreateFVF_DPipeline(VkRenderTarget* target, VKPipelineData& pipeline) {
    ...
    rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE;    rasterizer.cullMode = VK_CULL_MODE_NONE;    VkPipelineColorBlendAttachmentState colorBlendAttachment = {};
...
void WWVK_CreateFVF_NDUV_CAMUV_NOLPipeline(VkRenderTarget* target, VKPipelineData& pipeline) {
    VkShaderModule vertShaderModule = createShaderModule(target->device, WWVK_fvf_xyznduv1_camuv_vert, sizeof(WWVK_fvf_xyznduv1_camuv_vert));    VkShaderModule fragShaderModule = createShaderModule(target->device, WWVK_fvf_nduv2_noL_frag, sizeof(WWVK_fvf_nduv2_noL_frag));
...
void WWVK_CreateFVF_NDUV_CAMUV_NOLDescriptorSetLayout(VkRenderTarget * target, VKPipelineData& pipeline) {
...
void WWVK_UpdateFVF_NDUV_CAMUV_NOLDescriptorSets(VkRenderTarget * target, WWVK_Pipeline_Collection& pipeline, std::vector<VkDescriptorSet>& output, VK::Texture* texture_tex1, VK::Texture* texture_tex2, VK::Buffer ubo_ViewMatrix, VK::Buffer ubo_Projection) {
    VkDescriptorSet descriptorSet = target->getDescSet(VkDS_TTUU, pipeline.pipelines[PIPELINE_WWVK_FVF_NDUV_CAMUV_NOL].subIndex, &pipeline.pipelines[PIPELINE_WWVK_FVF_NDUV_CAMUV_NOL].descriptorSetLayout);
...
void WWVK_UpdateFVF_NDUV2DescriptorSets(VkRenderTarget * target, WWVK_Pipeline_Collection& pipeline, std::vector<VkDescriptorSet>& output, VK::Texture* texture_tex1, VK::Texture* texture_tex2, VK::Buffer ubo_ViewMatrix, VK::Buffer ubo_Projection) {
    VkDescriptorSet descriptorSet = target->getDescSet(VkDS_TTUU, pipeline.pipelines[PIPELINE_WWVK_FVF_NDUV2].subIndex, &pipeline.pipelines[PIPELINE_WWVK_FVF_NDUV2].descriptorSetLayout);
    VkWriteDescriptorSet descriptorWrites[4] = {};
...
void WWVK_UpdateTreesDescriptorSets(VkRenderTarget * target, WWVK_Pipeline_Collection& pipeline, std::vector<VkDescriptorSet>& output, VK::Texture* texture_tex1, VK::Texture* texture_tex2, VK::Buffer ubo_ViewMatrix, VK::Buffer ubo_Trees, VK::Buffer ubo_Projection) {
    ...
    descriptorWrites[3].descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
    descriptorWrites[3].descriptorCount = 1;
    descriptorWrites[3].pBufferInfo = &bufferInfo_Trees;
    VkDescriptorBufferInfo bufferInfo_Projection = {};
    bufferInfo_Projection.buffer = ubo_Projection.buffer;
    bufferInfo_Projection.offset = 0;
    bufferInfo_Projection.range = sizeof(Projection);
...
void WWVK_CreateVolumeShadowPipeline(VkRenderTarget* target, VKPipelineData& pipeline) {
    ...
    rasterizer.cullMode = VK_CULL_MODE_NONE;
    rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE;
    rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE;    rasterizer.cullMode = VK_CULL_MODE_FRONT_BIT;    VkPipelineColorBlendAttachmentState colorBlendAttachment = {};
    colorBlendAttachment.blendEnable = VK_TRUE;
...
void WWVK_CreateVolumeStencilShadowPipeline(VkRenderTarget* target, VKPipelineData& pipeline) {
    ...
    VkDynamicState dynamicState[3] = { VK_DYNAMIC_STATE_VIEWPORT , VK_DYNAMIC_STATE_SCISSOR, VK_DYNAMIC_STATE_STENCIL_COMPARE_MASK };
    VkPipelineDynamicStateCreateInfo dynamicStateCreateInfo = {};
    dynamicStateCreateInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO;
    dynamicStateCreateInfo.dynamicStateCount = 2;
    dynamicStateCreateInfo.pDynamicStates = dynamicState;
...
void WWVK_CreateStencilPlayerColorPipeline(VkRenderTarget* target, VKPipelineData& pipeline) {
    ...
    VkDynamicState dynamicState[7] = { VK_DYNAMIC_STATE_VIEWPORT , VK_DYNAMIC_STATE_SCISSOR, VK_DYNAMIC_STATE_STENCIL_COMPARE_MASK, VK_DYNAMIC_STATE_STENCIL_OP, VK_DYNAMIC_STATE_STENCIL_REFERENCE, VK_DYNAMIC_STATE_COLOR_WRITE_ENABLE_EXT, VK_DYNAMIC_STATE_DEPTH_WRITE_ENABLE };
    VkPipelineDynamicStateCreateInfo dynamicStateCreateInfo = {};
    dynamicStateCreateInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO;
    dynamicStateCreateInfo.dynamicStateCount = 2;
    dynamicStateCreateInfo.pDynamicStates = dynamicState;
...
void WWVK_PopulatePipeline(VkRenderTarget* target, WWVK_Pipeline_Collection& col)
{
    ...
    WWVK_CreateFVF_NDUV_CAMUV_NOLDescriptorSetLayout(target, col.pipelines[PIPELINE_WWVK_FVF_NDUV_CAMUV_NOL]);
    WWVK_CreateFVF_NDUV_CAMUV_NOLPipeline(target, col.pipelines[PIPELINE_WWVK_FVF_NDUV_CAMUV_NOL]);
...
{
    vkCmdBindPipeline(command, VK_PIPELINE_BIND_POINT_GRAPHICS, pipeline.pipelines[PIPELINE_WWVK_FVF_NDUV_CAMUV_NOL].graphicsPipeline);

    VkBuffer vertexBuffers[] = { uv,  };
    VkDeviceSize offsets[] = { offset_uv,  };
    vkCmdPushConstants(
        command,
        pipeline.pipelines[PIPELINE_WWVK_FVF_NDUV_CAMUV_NOL].pipelineLayout,
        VK_SHADER_STAGE_VERTEX_BIT,
        0,
        sizeof(WorldMatrix),
        push);
    ...
    vkCmdBindDescriptorSets(command, VK_PIPELINE_BIND_POINT_GRAPHICS, 
        pipeline.pipelines[PIPELINE_WWVK_FVF_NDUV_CAMUV_NOL].pipelineLayout, 0, static_cast<uint32_t>(sets.size()), sets.data(), 0, nullptr);
