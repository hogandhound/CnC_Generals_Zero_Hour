...
layout(set = 0, binding = 4) uniform UVT2{
	mat4 m1;
	mat4 m2;
} uvt;
...
void main() {
    ...
    // Pass the tex coword straight through to the fragment shader
    fragUv1 = (uvt.m1*vec4(uv,0,0)).xy;
	fragUv2 = (uvt.m2*vec4(uv,0,0)).xy;
