...
public:
	...
	static IDirect3DTexture9* Generate_Bumpmap(TextureClass* texture);
...
public:
	...
	IDirect3DTexture9* Peek_D3D_Texture() { return D3DTexture; }

	void Set_D3D_Texture(IDirect3DTexture9* texture);
};
