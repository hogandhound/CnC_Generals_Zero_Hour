...
Bool LayoutScheme::loadScheme( char *filename )
{
	...
	for( Int i = 0; i < numStates; i++ )
	{
		...
		// read all the data
		fscanf( fp, "%d: Image: %s Color: (%hhd,%hhd,%hhd,%hhd) Border: (%hhd,%hhd,%hhd,%hhd)\n",
